...
// Ruta de las imágenes para cada canción
const images = [
  'img/Flores Amarillas.png', // Imagen para 'Flores Amarillas'
  'img/Enchanted.png', // Imagen para 'Enchanted'
  'img/Yellow.png', // Imagen para 'Yellow' (corregí el error tipográfico 'pmg' a 'png')
  'img/Ocean Eyes.png', // Imagen para 'Ocean Eyes'
  'img/Car´s Outside.png', // Imagen para 'Car´s Outside'
  'img/Time After Time.png', // Imagen para 'Time After Time'
];
...
// Función para cargar la canción anterior
function prevSong() {
  currentSongIndex = (currentSongIndex - 1 + songs.length) % songs.length;
  loadSong(currentSongIndex);
}
